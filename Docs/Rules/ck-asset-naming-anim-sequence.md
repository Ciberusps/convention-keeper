...
**Animation Sequence** assets must use the prefix **AS_** (CKConvention).
...
CKConvention overrides the [UE5 Style Guide](https://github.com/Allar/ue5-style-guide/tree/v2?tab=readme-ov-file#122-animations) prefix for animation sequences: the style guide uses **A_**; CKConvention uses **AS_** for clarity and consistency with character animation naming (e.g. `AS_{CharacterName}_*`).
