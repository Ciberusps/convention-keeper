...
{ FName(TEXT("ck-asset-naming-anim-sequence")), TEXT("Ассеты Animation Sequence должны иметь префикс AS_ (CKConvention).") },
{ FName(TEXT("ck-asset-naming-state-tree")), TEXT("Ассеты StateTree должны иметь префикс ST_ (CKConvention).") },
